...
SIGNAL \inst|outpuport[0]~0_combout\ : std_logic;
...
-- Equation(s):
-- \inst|Equal0~0_combout\ = (!\SW[3]~input_o\ & !\SW[2]~input_o\)
...
\inst|outpuport[0]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|outpuport[0]~0_combout\ = (\SW[3]~input_o\) # ((!\SW[2]~input_o\ & \SW[1]~input_o\))
...
PORT MAP (
	...
	datab => \SW[2]~input_o\,
	datac => \SW[1]~input_o\,
	combout => \inst|outpuport[0]~0_combout\);
...
-- Equation(s):
-- \inst|Equal0~1_combout\ = (!\SW[3]~input_o\ & (!\SW[2]~input_o\ & (!\SW[1]~input_o\ & !\SW[0]~input_o\)))
